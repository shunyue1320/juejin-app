    ...
    <div class="topbar" :class="['topbar--'+(isTopbarBlock ? 'show' : 'hidden')]">
      <div class="topbar__main">
        ...
        <el-button-group class="ml-3">
          <el-button type="primary" size="small">{{ $t('topbar.write') }}</el-button>
          <el-button class="px-1" type="primary" size="small" icon="el-icon-caret-bottom"></el-button>
        </el-button-group>
        ...
        <el-button v-else class="login-btn" size="small" plain  @click="showLoginModal">{{ $t('menu.login') }}</el-button>
      </div>
    </div>
  </header>
</template>
